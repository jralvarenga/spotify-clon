...
export default function LoginWindow() {
  ...
  return (
    <div className="fixed z-50 flex h-screen w-full items-center justify-center bg-white/15 backdrop-blur-sm dark:bg-black/15">
      <div className="flex h-5/6 w-2/4 flex-col rounded-xl bg-card px-24 shadow-lg">
        <div className="flex flex-1 flex-col items-center justify-center gap-5 border-b border-gray-500">
          <SpotifyLogoIcon />
        ...
        <div className="flex items-center justify-center gap-1 border-t border-gray-500 p-10">
